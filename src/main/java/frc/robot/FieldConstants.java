...
public final class FieldConstants {
	...
	public static final double chargingStationCenterY = chargingStationLeftY + (chargingStationLength/2);
	...
	//new 3/2 -- check
	public static final Transform2d leftRedOffset = new Transform2d(new Translation2d(-1.5, Units.inchesToMeters(22.5)), new Rotation2d());
	public static final Transform2d rightRedOffset = new Transform2d(new Translation2d(-1.5, -Units.inchesToMeters(22.5)), new Rotation2d());
	public static final Transform2d centerRedOffset = new Transform2d(new Translation2d(-1.5, 0), new Rotation2d());
